...
let firstNameIndex = name.index(name.startIndex, offsetBy: 5)
print(name[..<firstNameIndex])
...
// slice the last name 
// the range of the string
let lastNameIndex = name.index(name.endIndex, offsetBy: -4)
print(name[lastNameIndex..<name.endIndex])
